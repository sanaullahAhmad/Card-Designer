...
<?php if($row['element_json'] != '') { ?>
	   <li class="col-lg-6 col-md-8 col-xs-12 thumb" id="<?php echo $row['id']; ?>" style="padding:5px;">
		  <a class="thumbnail" href="javascript:loadElement(<?php echo $row["id"]; ?>);" style="margin-bottom: 0;">
			<img class="img-responsive" data-index='circle' data-label='circle' data-subtitle='object' data-content='circlecontent' data-imgsrc="<?php echo $row['element_path']; ?>" src="<?php echo $row['element_path']; ?>" alt="" style="width:80px; height:80px;">
...
<?php } else { ?>
	   <li class="col-lg-6 col-md-8 col-xs-12 thumb" id="<?php echo $row['id']; ?>" style="padding:5px;">
		  <a class="thumbnail" href="#" style="margin-bottom: 0;">
			<img class="catImage img-responsive" data-index='circle' data-label='circle' data-subtitle='object' data-content='circlecontent' data-imgsrc="<?php echo $row['element_path']; ?>" src="<?php echo $row['element_path']; ?>" alt="" style="width:80px; height:80px;">
		  </a><input type="checkbox" class="catimg-checkbox" id="<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>" />
	   </li>
<?php } ?>
