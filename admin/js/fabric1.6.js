  ...
  extend(fabric, {
    ...
    createSVGFontFacesMarkup: function(objects) {
      ...
      for (var i = 0, len = objects.length; i < len; i++) {
        ...
        objects[i].path = 'http://design.youprintem.com/admin/tcpdf/fonts/googlefonts/' + objects[i].fontFamily.replace(" ", "_") + '/' + objects[i].fontFamily.replace(" ", "") + '-Regular.ttf';
...
(function(global) {
  ...
  fabric.Object = fabric.util.createClass(/** @lends fabric.Object.prototype */ {
    ...
    stateProperties:  (
      ...
      'alignX alignY meetOrSlice skewX skewY lockMovementX lockMovementY lockScalingX lockScalingY'
    ).split(' '),
