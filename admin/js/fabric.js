        ...
        toSVG: function(object, normalize) {
            ...
            for (var i = 0; i < this.colorStops.length; i++) {
                markup.push(
                    ...
                    '" style="stop-color:', this.colorStops[i].color, (this.colorStops[i].opacity != null ? ';stop-opacity: ' + this.colorStops[i].opacity : ';'),
                    '"/>\n'
                    //jscs:enable validateIndentation
                );
            }
    ...
    fabric.StaticCanvas = fabric.util.createClass( /** @lends fabric.StaticCanvas.prototype */ {
        ...
        _setSVGHeader: function(markup, options) {
            markup.push(
                ...
                'height="', (options.viewBox ? options.viewBox.height : this.height), '" ', (this.backgroundColor && !this.backgroundColor.toLive ? 'style="background-color: ' + this.backgroundColor + '" ' : null), (options.viewBox ? 'viewBox="' +
                    options.viewBox.x + ' ' +
                    options.viewBox.y + ' ' +
        ...
        _setSVGBgOverlayColor: function(markup, property) {
            ...
            } else if (this[property] && property === 'backgroundColor') {
                markup.push(
                    '<rect x="0" y="0" ',
                    'width="', this.width,
                    '" height="', this.height,
    ...
    getSvgTransform: function() {
        ...
        var toFixed = fabric.util.toFixed,
            ...
            (' scale(' +
                ...
                ')'),
            addTranslateX = this.type === 'path-group' ? this.width * vpt[0] : this.width * vpt[0],
            flipXPart = this.flipX ? ' matrix(-1 0 0 1 ' + addTranslateX + ' 0) ' : '',
            addTranslateY = this.type === 'path-group' ? this.height * vpt[3] : this.height * vpt[3],
...
(function() {
    ...
    fabric.util.object.extend(fabric.Object.prototype, /** @lends fabric.Object.prototype */ {
        ...
        drawBorders: function(ctx) {
            ...
            ctx.strokeRect(~~(-(width / 2) - padding) - 0.5, // offset needed to make lines look sharper
                ~~(-(height / 2) - padding) - 0.5, ~~(width + padding2) + 1, // double offset needed to make lines look sharper
                ~~(height + padding2) + 1
            );
...
(function(global) {
    ...
    fabric.Text = fabric.util.createClass(fabric.Object, /** @lends fabric.Text.prototype */ {
        ...
        _wrapSVGTextAndBg: function(markup, textAndBg, shadowSpans, offsets) {
            ...
            if (textAndBg.textSpans.length == 4) {
                ...
                markup.push(
                    ...
                    'transform="translate(', toFixed(offsets.textLeft, 2), ' ', 0, ')">',
                    shadowSpans.join(''),
...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
    ...
    initHiddenTextarea: function() {
        ...
        //https://github.com/kangax/fabric.js/issues/1310
...
fabric.util.object.extend(fabric.IText.prototype, /** @lends fabric.IText.prototype */ {
    ...
    _createTextCharSpan: function(_char, styleDecl, lineLeftOffset, lineTopOffset, yProp, charOffset) {
        ...
        return [
            //jscs:disable validateIndentation
            '<tspan xml:space="preserve" x="', lineLeftOffset + charOffset, '" ',
            yProp, '="', lineTopOffset, '" ',
