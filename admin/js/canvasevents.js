function initCanvas(canvasid) {
    ...
    var client_w = $('#canvasbox-tab').innerWidth();
    var client_h = $('#canvasbox-tab').innerHeight();
    canvas.setWidth(client_w);
    canvas.setHeight(client_h);
    ...
    canvas.observe('object:selected', function (e) {
       ...
       $('#storkewidth').val(selectedObject.strokeWidth);
        ...
        if (selectedObject.type == "cropzoomimage") {
			 $("#replace_image").css("visibility", "visible");
		 } else {
            $("#replace_image").hide();
  		}
