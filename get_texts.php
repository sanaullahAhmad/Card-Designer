<?php
	...
	if(mysqli_num_rows($runQuery) > 0)
	{
		...
		{
?>
	   <li class="col-lg-6 col-md-8 col-xs-12 thumb" id="<?php echo $row['text_id']; ?>" style="padding:5px;">
		  <a class="thumbnail" title="<?php echo $row['text_name']; ?>" href='javascript:loadText(<?php echo $row["text_id"]; ?>);' style="margin-bottom: 0;">
			<img class="textImage img-responsive" src="<?php echo $row['text_thumbnail']; ?>" alt="" style="width:100px">
