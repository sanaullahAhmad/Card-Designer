<?php
	...
	$insert_Qry = "INSERT INTO user_templates (template_id, product_id, userid, template_name, canvas_thumbnail, canvas_json, created_date, modified_date) VALUES ('','$_POST['getvar']', '1', '".$_POST['filename']."', '', '', now(), now())";
